...
import it.quiz.conductiontest.web.rest.UserProfileResource;
...
public class UserProfileResourceIntTest {
    ...
    private static final Integer DEFAULT_EXP_LEVEL = 1;
    private static final Integer UPDATED_EXP_LEVEL = 2;
    ...
    public void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getContact()).isEqualTo(DEFAULT_CONTACT);
        assertThat(testUserProfile.getDomain()).isEqualTo(DEFAULT_DOMAIN);
        assertThat(testUserProfile.getExpLevel()).isEqualTo(DEFAULT_EXP_LEVEL);
    }
    ...
    public void getAllUserProfiles() throws Exception {
        ...
        restUserProfileMockMvc.perform(get("/api/user-profiles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].expLevel").value(hasItem(DEFAULT_EXP_LEVEL)));
    }
    ...
    public void getUserProfile() throws Exception {
        ...
        restUserProfileMockMvc.perform(get("/api/user-profiles/{id}", userProfile.getId()))
            ...
            .andExpect(jsonPath("$.expLevel").value(DEFAULT_EXP_LEVEL));
    }
    ...
    public void updateUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getContact()).isEqualTo(UPDATED_CONTACT);
        assertThat(testUserProfile.getDomain()).isEqualTo(UPDATED_DOMAIN);
        assertThat(testUserProfile.getExpLevel()).isEqualTo(UPDATED_EXP_LEVEL);
    }
